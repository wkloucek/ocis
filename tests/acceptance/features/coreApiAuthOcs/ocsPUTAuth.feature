@api @files_sharing-app-required @S6dbc1849
Feature: auth

  Background:
    Given user "another-admin" has been created with default attributes and without skeleton files

  @issue-ocis-reva-30 @smokeTest @skipOnBruteForceProtection @issue-brute_force_protection-112 @Tb08551e8
  ...
  @issue-38423 @skipOnOcV10 @T00d39540
