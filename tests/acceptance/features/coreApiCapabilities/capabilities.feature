@api @files_sharing-app-required @issue-ocis-reva-41 @Se386d75d
Feature: capabilities

  Background:
    Given using OCS API version "1"

  @smokeTest @skipOnOcis @T174c6cbf
  ...
  @smokeTest @skipOnOcis @T6987afae
  ...
  @smokeTest @skipOnOcis @T86f2db6c
  ...
  @smokeTest @skipOnOcis @T5cbc852e
  ...
  @smokeTest @skipOnOcis @T9103de86
  ...
  @smokeTest @skipOnOcis @T0b5ce853
  ...
  @smokeTest @skipOnOcis @Tce8d0737
  ...
  @files_trashbin-app-required @skipOnReva @T5df55512
  ...
  @files_versions-app-required @skipOnReva @Tb06e0c2b
  ...
  @smokeTest @skipOnOcis @Tf244521b
