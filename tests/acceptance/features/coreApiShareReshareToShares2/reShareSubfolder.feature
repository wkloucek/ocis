@api @files_sharing-app-required @issue-ocis-1328 @S8359454e
Feature: a subfolder of a received share can be reshared
  ...
  @smokeTest @issue-ocis-2214 @T64ab8828
